...
reconstructed_model = keras.models.load_model("../AI PBL project/pretrained models/cnn_malaria.h5")

image_path = '../AI PBL project/cell_images/Uninfected/C1_thinF_IMG_20150604_104722_cell_73.png'
